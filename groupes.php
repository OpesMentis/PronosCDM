...
<body>
    ...
    <table width="100%" align="center">
        <tr>
            ...
            <td width="20%" align="center">
                <font style="font-family: 'Open Sans'; font-size: 15px;"><a href="divers.php">Paris divers</a></font><br/>
            </td>
        </tr>
    </table>
    <table width="90%" align="center">
        ...
        for ($i = 0; $i < count($grp); $i++) {
            ...
            <td width="20%" align="center">
                ...
                <select name=<?php echo '"' . $grp[$i] . '1" ' . ($_SESSION['login'] != 'admin' && strtotime('2018-06-18 17:00:00') < strtotime('now') ? 'disabled': '');?>>
                ...
                <select name=<?php echo '"' . $grp[$i] . '2" ' . ($_SESSION['login'] != 'admin' && strtotime('2018-06-18 17:00:00') < strtotime('now') ? 'disabled': '');?>>
                    <option value="0">--</option>
                    <?php
                    for ($j = 0; $j < 4; $j++) {
