...
<body>
    ...
    <table width="90%" align="center">
        <form action="petitefinale.php" method="post">
            ...
            if (($_SESSION['login'] == 'admin' || strtotime('2018-06-14 15:00:00') > strtotime('now')) && isset($_POST['1']) && $j1 != '0' && $j2 != '0') {
            ...
            ?>
            <td width="20%" align="center">
                <font style="font-size: 20px;">Petite finale</font><br/>
                <font style="font-size: 15px;">Vainqueur</font>
                <select name=<?php echo '"1" ' . ($_SESSION['login'] != 'admin' && strtotime('2018-06-14 15:00:00') < strtotime('now') || $j1 == '0' || $j2 == '0' ? 'disabled': '');?>>
    ...
    <table width="90%" align="center">
        <tr>
            ...
            <td width="15%" align="center">
                <font style="font-size: 15px;"><b>La petite finale</b></font><br/>
            </td>
            <td width="15%" align="center">
